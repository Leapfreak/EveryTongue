...
; CUDA runtime DLLs + AWS SDK are Download Manager dependencies, not app files — never bundle
Source: "{#AppPublishDir}\*.dll"; DestDir: "{app}"; Excludes: "cublas*.dll,cublasLt*.dll,cudart*.dll,cudnn*.dll,cufft*.dll,nvrtc*.dll,zlibwapi.dll,AWSSDK.*.dll"; Flags: ignoreversion
