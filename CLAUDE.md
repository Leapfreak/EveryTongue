...
- Heuristic tier (findings = suspects for human review): `audit-language-lists` (inline language-code collections outside the canonical table/registry), `audit-pipe-drain` (pipe redirect + WaitForExit without reading both pipes).
