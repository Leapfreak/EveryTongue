...
echo ""
echo "  Admin page:        https://$SHOWN_HOST:5081/admin.html"
echo ""
echo "  First time: accept the one-time certificate warning, open the"
echo "  Admin page (PIN 1234), choose your engines, paste YOUR API keys,"
echo "  and change the PIN."
echo ""
echo "  Config persists in: $CONFIG_DIR"
echo "  Bible panel (optional): install Bibles from Settings in the browser,"
echo "  or copy .sqlite3 Bibles into $CONFIG_DIR/Bibles"
