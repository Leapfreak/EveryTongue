...
Public Class FormTemplateManager
    ...
    Private Sub ApplyLocale()
        ...
        grpDetail.Text = lp.GetString("Tmpl_Details")
        btnRefreshDevices.Text = lp.GetString("CC_Refresh")
        btnSave.Text = lp.GetString("Tmpl_Save")
        btnCancelEdit.Text = lp.GetString("Btn_Cancel")
