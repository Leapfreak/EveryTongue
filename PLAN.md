...
- **Language change in-room is a RIGHT, never a privilege.** The translation picker/dropdown stays available to every tier in every room, always — no future tier work may gate it.
