...
**Field / ops:**
- [x] ~~Jezer: clean install of v2.11.0~~ — DONE (rehearsals 07-29/30 ran on it; the field findings drove v2.11.1). **Next: re-sync Jezer to v2.11.1** (whole bin\Publish or the in-app updater), then section A + A2 above. (`tools/fix_spavbl.py` if the Spanish Bible is installed.)
