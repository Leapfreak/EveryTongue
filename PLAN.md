...
**Field / ops:**
- [ ] **Jezer: clean v2.10.1 install** — fixes EOU retune flip-flop (pre-2026-07-12 hysteresis on that machine), the WebSockets-assembly startup crash (partial install), and mixed file vintages. THEN generate + load the biblical vocab (Download Manager → Biblical Vocabulary) — field machine still runs vocab=0 while the feature is now PROVEN.
