...
Namespace Controllers
    ...
    Friend Class ConferenceController
        ...
        ''' <summary>Marshals handler work onto the host's main thread. The desktop
        ''' passes a Form.BeginInvoke wrapper; a headless host passes Sub(a) a()
        ''' (its handlers have no UI thread to protect). Keeps this class WinForms-free.</summary>
