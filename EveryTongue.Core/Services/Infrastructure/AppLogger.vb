...
Namespace Services.Infrastructure
    ...
    Public Module AppLogger
        ...
        ''' <summary>
        ''' Yes/No confirmation used by PromptDownloadManager. Set by FormMain to a
        ''' MessageBox lambda; when unset (headless host) the prompt is log-only and
        ''' answers No. Keeps this module free of WinForms.
        ''' </summary>
        Public ConfirmPrompt As Func(Of String, String, Boolean)
        ...
        Public Sub PromptDownloadManager(message As String, title As String)
            ...
            Dim confirm = ConfirmPrompt
            If confirm Is Nothing Then Return   ' headless host: logged above, no dialog
            If confirm(message, title) Then
