...
Namespace Services.Infrastructure
    ...
    Public Class CertificateService
        ...
        Public ReadOnly Property CertificatePath As String Implements ICertificateService.CertificatePath
            Get
                ' Same directory as config.json — honours EVERYTONGUE_CONFIG_DIR so the
                ' cert survives container restarts on the /config volume.
                Return Path.Combine(Global.EveryTongue.Models.ConfigManager.ConfigDirectory, CertFileName)
            End Get
        End Property
