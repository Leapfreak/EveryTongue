...
Write-Host "  Admin page:        https://${ShownHost}:5081/admin.html"
Write-Host ""
Write-Host "  First time: accept the one-time certificate warning, open the"
Write-Host "  Admin page (PIN 1234), choose your engines, paste YOUR API keys,"
Write-Host "  and change the PIN."
Write-Host ""
Write-Host "  Config persists in: $ConfigDir"
Write-Host "  Bible panel (optional): install Bibles from Settings in the browser,"
Write-Host "  or copy .sqlite3 Bibles into $ConfigDir\Bibles"
